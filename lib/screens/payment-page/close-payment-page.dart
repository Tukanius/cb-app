...
class ClosePaymentPageArguments {
  String code;
...
class ClosePaymentPage extends StatefulWidget {
  ...
  static const routeName = 'ClosePaymentPage';
  ...
  @override
  State<ClosePaymentPage> createState() => _ClosePaymentPageState();
}

class _ClosePaymentPageState extends State<ClosePaymentPage>
                    ...
                    Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '${Utils().formatCurrency(widget.closeAmount)} ₮',
                              style: TextStyle(
                                color: Theme.of(context).iconTheme.color,
                                fontSize: 24,
                                fontWeight: FontWeight.bold,
                      ...
                      onTap: () {
                        Navigator.of(context).pushNamed(
                          ...
                          arguments: BankTransferPageArguments(
                              code: widget.code,
                              totalPayAmount: widget.todayAmount),
                        );
                      },
                      child: Container(
                        margin: EdgeInsets.symmetric(vertical: 4),
